...
/**
 * A list fragment representing a list of Words. This fragment
 * also supports tablet devices by allowing list items to be given an
 * 'activated' state upon selection. This helps indicate which item is
 * currently being viewed in a {@link WordDetailFragment}.
 * <p/>
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        */
        CursorLoader cursorLoader = new CursorLoader(
                ...
                new String[]{BaseColumns._ID,VocabolarioCasuDatabase.KEY_WORD},
                null, //selection
                null, //selection Args
                VocabolarioCasuDatabase.KEY_WORD+" ASC");//sort order

        cursor = cursorLoader.loadInBackground();
        if(cursor == null){
            Log.d(TAG, "cursor is null");
        }
        String[] from  = new String[]{VocabolarioCasuDatabase.KEY_WORD};
